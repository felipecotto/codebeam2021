        ...
        <section className={styles.diversity}>
            <div className="container">
                ...
                <div className="col-md-12">
                    ...
                    <p>Estamos sempre procurando melhorar a diversidade das nossas conferências. Para ajudar a alcançar isso, 
                        nós e a EEF estamos fornecendo ingressos gratuitos  para grupos sub-representados em tecnologia. 
